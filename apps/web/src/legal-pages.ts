...
<ul>
<li><code>https://www.googleapis.com/auth/calendar.events</code>: to create, update and delete the calendar events myna makes for posts you schedule to your calendar, so a scheduled post shows up at the right time and disappears if you cancel it.</li>
